#pragma checksum "C:\Users\USER\Downloads\Blog\Blog\Blog\Views\Home\Privacy.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "26e740caa9dad462932a08ee36f8b600dd1f597f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"26e740caa9dad462932a08ee36f8b600dd1f597f", @"/Views/Home/Privacy.cshtml")]
    ...
    public class Views_Home_Privacy : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\USER\Downloads\Blog\Blog\Blog\Views\Home\Privacy.cshtml"
...
#nullable disable
            WriteLiteral("<h1>");
#nullable restore
#line 4 "C:\Users\USER\Downloads\Blog\Blog\Blog\Views\Home\Privacy.cshtml"
...
<p><strong>1.1 В настоящей Политике конфиденциальности используются следующие термины:<strong></strong></strong></p>
        ...
        <p>
            ...
            данных, состав персональных данных, подлежащих обрабо");
            WriteLiteral(@"тке, действия (операции), совершаемые с персональными данными.
        </p>
        ...
        <p>
            ...
            к персональным данным лицом требование не до");
            WriteLiteral(@"пускать их распространения без согласия субъекта персональных данных или
        ...
        <p>
            ...
            и использующее информацию, материалы и продукты сайта <strong>BlogCreater</strong>.
        </p>

        <p>
            1.1.7.");
            WriteLiteral(@" «Cookies» — небольшой фрагмент данных, отправленный веб-сервером и хранимый на компьютере пользователя,
        ...
        <p>
            2.3. Настоящая Политика конфиденциальности применяется к сайту BlogCreater.
            Blog не контролирует и не н");
            WriteLiteral(@"есет ответственность за сайты третьих лиц, на которые Пользователь
        ...
        <p>
            ...
            Пользователем путём заполнения форм на сайте BlogCreater и включают в себя следующую информацию:<br>
            3.2.1. фамилию, имя, отчество Пользователя;<br>
          ");
            WriteLiteral(@"  3.2.2. контактный телефон Пользователя;<br>
        ...
        <p>
            3.4. Любая иная персональная информация н");
            WriteLiteral(@"еоговоренная выше (история посещения, используемые браузеры, операционные
       ...
       ");
            WriteLiteral(@"     4.1.5. Подтверждения достоверности и полноты персональных данных, предоставленных Пользователем.<br>
        ...
        <p>
            ...
            WriteLiteral(@"ызванных утратой или разглашением персональных данных Пользователя.
        </p>
        ...
        <p>
            ...
            WriteLiteral(@" для заявленной цели обработки, а также
        ...
        <p>
            ...
            обычно используемого для защи");
            WriteLiteral(@"ты такого рода информации в существующем деловом обороте.
        </p>
        ...
        <p>
            7.2. В случае утраты или разглашения Конфиденциальной информации Администрац");
            WriteLiteral(@"ия не несёт ответственность,
...
");
        ...
        <h2>8");
            WriteLiteral(@". Разрешение споров</h2>
        ...
        <p>9.1. Администрация вправе вносить изменения в настоящую Политику конфиденц");
            WriteLiteral(@"иальности без согласия Пользователя.</p>
